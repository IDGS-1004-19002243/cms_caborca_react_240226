                ...
                <div className="absolute inset-0 bg-black/40 flex items-center justify-center">
                  <div className="text-center text-white px-4">
                    <div className="inline-block bg-caborca-cafe px-6 py-2 rounded-lg mb-6">
                      <span className="text-sm md:text-base font-bold tracking-widest uppercase text-white block">{idioma === 'es' ? content.hero.badge_ES || content.hero.badge : content.hero.badge_EN || content.hero.badge}</span>
                    </div>
